    ...
    methods: {
        ...
        async addCategory() {
            try {
                ...
                await axios.post('/Admin/ChuDe/AddChuDe', formData,
                    {
                        headers: {
        ...
        getItemsById(id) {
            axios.get(`/Admin/ChuDe/GetByIDChuDe/${id}`)
                .then((response) => {
        ...
        async editCategory() {
            try {
                ...
                await axios.post('/Admin/ChuDe/UpdateChuDe', formData,
                    {
                        headers: {
                            'Content-Type': 'multipart/form-data'
                        }
                    ...
                    if (this.idCm != null) {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                const formData = new FormData();
                                formData.append('ID', this.idCm);
                                axios.post('/Admin/ChuDe/DeleteChuDe', formData, {
                                    headers: {
