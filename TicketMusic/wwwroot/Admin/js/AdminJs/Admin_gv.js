    ...
    methods: {
        ...
        async addCategory() {
            try {
                ...
                await axios.post('/Admin/GiaoVien/AddGiaoVien', formData,
                    {
                        headers: {
        ...
        getItemsById(id) {
            axios.get(`/Admin/GiaoVien/GetByIDGiaoVien/${id}`)
                .then((response) => {
        ...
        async editCategory() {
            try {
                ...
                formData.append('CongViec', this.congViec);
                formData.append('NoiLamViec', this.noiLamViec);
                formData.append('DetailsGiaoVien', this.detailsCkName);
                ...
                await axios.post('/Admin/GiaoVien/UpdateGiaoVien', formData,
                    {
                        headers: {
                            'Content-Type': 'multipart/form-data'
                        }
                    ...
                    if (this.idGv != null) {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                const formData = new FormData();
                                formData.append('ID', this.idGv);
                                axios.post('/Admin/GiaoVien/DeleteGiaoVien', formData, {
                                    headers: {
