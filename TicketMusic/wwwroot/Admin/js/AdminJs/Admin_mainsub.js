var mainsub_vue = new Vue({
    ...
    methods: {
        ...
        loadCateItems() {
            ...
            axios.get("/Admin/MainSubCourse/GetAllSubCategory")
                .then((response) => {
        ...
        async addCategory() {
            try {
                ...
                await axios.post('/Admin/MainSubCourse/AddSub', formData,
                    {
                        headers: {
        ...
        getItemsById(id) {
            axios.get(`/Admin/MainSubCourse/GetByIDSub/${id}`)
                .then((response) => {
        ...
        async editCategory() {
            try {
                ...
                await axios.post('/Admin/MainSubCourse/UpdateSub', formData,
                    {
                        headers: {
                            'Content-Type': 'multipart/form-data'
                        }
                    ...
                    if (this.idSubCate != null) {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                const formData = new FormData();
                                formData.append('ID', this.idSubCate);
                                axios.post('/Admin/MainSubCourse/DeleteSub', formData, {
                                    headers: {
