var subHeader_vue = new Vue({
    ...
    mounted() {
        this.loadCateItems();
        axios.get("/Admin/MainHeader/GetAllCategory")
            .then((response) => {
    ...
    methods: {
        ...
        loadCateItems() {
            ...
            axios.get("/Admin/SubHeader/GetAllCategory")
                .then((response) => {
        ...
        async addCategory() {
            try {
                ...
                await axios.post('/Admin/SubHeader/AddCategory', formData,
                    {
                        headers: {
        ...
        getItemsById(id) {
            axios.get(`/Admin/SubHeader/GetByIDCategory/${id}`)
                .then((response) => {
        ...
        async editCategory() {
            try {
                ...
                await axios.post('/Admin/SubHeader/UpdateCategory', formData,
                    {
                        headers: {
                            'Content-Type': 'multipart/form-data'
                        }
                    ...
                    if (this.idCategory != null) {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                const formData = new FormData();
                                formData.append('ID', this.idCategory);
                                axios.post('/Admin/SubHeader/DeleteCategory', formData, {
                                    headers: {
