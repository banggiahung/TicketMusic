    ...
    methods: {
        ...
        async addCategory() {
            try {
                ...
                formData.append('url', `/khoa-hoc/${this.SlugSub}`);

                await axios.post('/Admin/SubCategory/AddSub', formData,
                    {
                        headers: {
        ...
        getItemsById(id) {
            axios.get(`/Admin/SubCategory/GetByIDSub/${id}`)
                .then((response) => {
        ...
        async editCategory() {
            try {
                ...
                await axios.post('/Admin/SubCategory/UpdateSub', formData,
                    {
                        headers: {
                            'Content-Type': 'multipart/form-data'
                        }
                    ...
                    if (this.idSubCate != null) {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                axios.post('/Admin/SubCategory/DeleteSub', formData, {
                                    headers: {
