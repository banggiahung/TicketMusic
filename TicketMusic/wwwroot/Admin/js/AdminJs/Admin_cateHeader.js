    ...
    methods: {
        ...
        async addCategory() {
            try {
                ...
                await axios.post('/Admin/MainHeader/AddCategory', formData,
                    {
                        headers: {
        ...
        getItemsById(id) {
            axios.get(`/Admin/MainHeader/GetByIDCategory/${id}`)
                .then((response) => {
        ...
        async editCategory() {
            try {
                ...
                await axios.post('/Admin/MainHeader/UpdateCategory', formData,
                    {
                        headers: {
                            'Content-Type': 'multipart/form-data'
                        }
                    ...
                    if (this.idCategory != null) {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                const formData = new FormData();
                                formData.append('ID', this.idCategory);
                                axios.post('/Admin/MainHeader/DeleteCategory', formData, {
                                    headers: {
