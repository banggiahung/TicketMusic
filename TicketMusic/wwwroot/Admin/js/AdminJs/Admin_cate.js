var Admin_cate = new Vue({
    ...
    methods: {
        ...
        loadCateItems() {
            ...
            axios.get("/Admin/Categories/GetAllCategory")
                .then((response) => {
        ...
        async addCategory() {
            try {
                ...
                formData.append('CategoryName', this.NameCategory);
                formData.append('Slug', this.SlugCategory);
                formData.append('PickColor', this.pickColor);

                await axios.post('/Admin/Categories/AddCategory', formData,
                    {
                        headers: {
        ...
        getItemsById(id) {
            axios.get(`/Admin/Categories/GetByIDCategory/${id}`)
                .then((response) => {
                    this.idCategory = response.data.categoryID;
                    this.NameCategory = response.data.categoryName;
                    this.pickColor = response.data.pickColor;
                    return Promise.resolve();
                });
        },
        resetDataCategory() {
        ...
        async editCategory() {
            try {
                ...
                await axios.post('/Admin/Categories/UpdateCategory', formData,
                    {
                        headers: {
                            'Content-Type': 'multipart/form-data'
                        }
                    ...
                    if (this.idCategory != null) {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                const formData = new FormData();
                                formData.append('CategoryID', this.idCategory);
                                axios.post('/Admin/Categories/DeleteCategory', formData, {
                                    headers: {
