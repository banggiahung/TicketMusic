var Admin_catesource = new Vue({
    ...
    methods: {
        ...
        UpdateHandel() {
            ...
            axios.post('/Admin/CategoryCourse/UpdateHandel', formData,
                {
                    headers: {
        ...
        async addCategory() {
            try {
                ...
                formData.append('ColNumID', 3);
                formData.append('OrderNumber', this.OrderNumber);


                await axios.post('/Admin/CategoryCourse/AddCategory', formData,
                    {
                        headers: {
                            'Content-Type': 'multipart/form-data'
                        }
        ...
        getItemsById(id) {
            axios.get(`/Admin/CategoryCourse/GetByIDCategory/${id}`)
                .then((response) => {
        ...
        async editCategory() {
            try {
                ...
                await axios.post('/Admin/CategoryCourse/UpdateCategory', formData,
                    {
                        headers: {
                            'Content-Type': 'multipart/form-data'
                        }
                    ...
                    if (this.idCm != null) {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                const formData = new FormData();
                                formData.append('ID', this.idCm);
                                axios.post('/Admin/CategoryCourse/DeleteCategory', formData, {
                                    headers: {
