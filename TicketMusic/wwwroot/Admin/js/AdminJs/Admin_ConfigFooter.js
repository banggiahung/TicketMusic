var config_footer = new Vue({
    ...
    methods: {
        loadData() {
            ...
            axios.get("/Admin/Page/GetAllPagePostTitle")
                .then((response) => {
            ...
            axios.get("/Admin/Support/GetAllPagePostTitle")
                .then((response) => {
            ...
            axios.get("/Admin/FooterConfig/GetAllFooter")
                .then((response) => {
        ...
        handleCheckboxChange(item) {
            ...
            if (item.checked) {
                try {
                    ...
                    axios.post('/Admin/FooterConfig/AddFooter', formData, {
                        headers: {
                ...
                try {
                    formData.append('CauHinhFooter1', item.id);
                    axios.post('/Admin/FooterConfig/DeleteFooter', formData, {
                        headers: {
                            'Content-Type': 'application/x-www-form-urlencoded'
                        }
                    }).then(res => {
        ...
        handleCheckboxChangeSup(item) {
            ...
            if (item.checked) {
                try {
                    ...
                    axios.post('/Admin/FooterConfig/AddFooterSup', formData, {
                        headers: {
                            'Content-Type': 'application/x-www-form-urlencoded'
                        }
                    }).then(res => {
                ...
                try {
                    formData.append('CauHinhHoTro', item.id);
                    axios.post('/Admin/FooterConfig/DeleteFooterSup', formData, {
                        headers: {
                            'Content-Type': 'application/x-www-form-urlencoded'
                        }
                    }).then(res => {
