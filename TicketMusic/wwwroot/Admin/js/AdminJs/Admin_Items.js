var edit_items = new Vue({
    ...
    mounted() {
        ...
        axios.get(`/Admin/Course/GetSub/${this.idSub}`)
            .then((response) => {
                this.DataSubCateMain = response.data;

                return Promise.resolve();
            });
        axios.get(`/Admin/Course/GetSubMain/${this.MainID}`)
            .then((response) => {
        ...
        getItemsById(id) {
            ...
            axios.get(`/Admin/Course/GetByIDCourse/${id}`)
                ...
                .then((response) => {
                    ...
                    this.ShortDescripton = response.data.shortDescripton;
                ...
                .then((response) => {
                    ...
                    try {
                        ...
                        if (this.slugURL === this.slug) {
                            ...
                            formData.append('oldUrl', `/${this.slugCateEdit}/${this.slugURL}`);
                            formData.append('newUrl', `/${this.slugCateNew}/${this.Slug}`);
                        }
                        ...
                        axios.post('/Admin/Course/UpdateCourse', formData,
                            {
                                headers: {
                                    'Content-Type': 'multipart/form-data'
                                }
