Admin_Course = new Vue({
    ...
    mounted() {
        ...
        $('#preloader').fadeIn();
        this.loadSubItems();
        axios.get("/Admin/CategoryCourse/GetAllCategory")
            .then((response) => {
                this.dataCm = response.data;

                return Promise.resolve();
            });
        axios.get("/Admin/SubCategory/GetAllSubCategory")
            .then((response) => {
    ...
    methods: {
        getCateCourseName(id) {
            const category = this.dataCm.find(item => item.id === id);
        ...
        loadCate(idSub) {
            ...
            axios.get(`/Admin/Course/GetSub/${idSub}`)
                .then((response) => {
        ...
        loadSubItems() {
            ...
            axios.get("/Admin/Course/GetAllCourse")
                .then((response) => {
        ...
        async addProducts() {
            try {
                ...
                formData.append('ShortDescripton', this.ShortDescripton);
                ...
                formData.append('url', `/${slugCate}/${this.Slug}`);


                await axios.post('/Admin/Course/AddCourse', formData,
                    {
                        headers: {
                            'Content-Type': 'multipart/form-data'
                        }
        ...
        getItemsById(id) {
            axios.get(`/Admin/Course/GetByIDCourse/${id}`)
                .then((response) => {
        ...
        async getItemsByIdDelete(id) {
            ...
            try {
                const response = await axios.get(`/Admin/Course/GetByIDCourse/${id}`);
                this.id = response.data.courseID;
                this.MainID = response.data.mainSubID;
                this.Slug = response.data.slug;
                await axios.get(`/Admin/Course/GetSubMain/${this.MainID}`)
                    .then((response) => {
                        this.DataSubCateMain = response.data;
                        ...
                        if (this.id != null) {
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    ...
                                    axios.post('/Admin/Course/DeleteCourse', formData, {
                                        headers: {
